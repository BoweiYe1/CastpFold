...
//         </a>{' '}
//         database, Predicted GO/EC terms are from {' '} <a target='_blank' rel='noopener noreferrer' href='https://github.com/flatironinstitute/DeepFRI'> DeepFRI </a>{' '} method, and reference can be found in 
//         {' '} <a target='_blank' rel='noopener noreferrer' href='https://geneontology.org/'> The Gene Ontology Resource </a>{' '} database.
//       </p>
//     );
...
//       <span>
//         {' '}
//         Annotation/Predicted Functional{' '}
...
//     // Define the columns based on the searchID condition
//     let columns = [];
//     if (this.props.searchid.length > 4 && this.props.searchid.length < 14) {
//       columns = [
